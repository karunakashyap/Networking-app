        ...
        <div className={styles.agginableData}>
            <div>
                <div className={styles.assignPoint}>
                    ...
                    <p style={{ fontWeight: 'bold' }}>1000 Points<img src='/dollar-icon1.svg' alt='' width={17} height={17}></img></p>
                ...
                <div className={styles.assignPointImage}>
                    ...
                    <div className={styles.allpoints} >
                        <div className="grid grid-cols-5 w-70">
                            <div className="...">Surbhi<br></br>100<img src='/dollar-icon1.svg' alt='' width={12} height={12}></img></div>
                            <div className="...">Surbhi<br></br>100<img src='/dollar-icon1.svg' alt='' width={12} height={12}></img></div>
                            <div className="..." style={{ marginLeft: '4px' }}>Surbhi<br></br>100<img src='/dollar-icon1.svg' alt='' width={12} height={12}></img></div>
                            <div className="..." style={{ marginLeft: '4px' }}>Surbhi<br></br>100<img src='/dollar-icon1.svg' alt='' width={12} height={12}></img></div>
                        </div>
                    </div>
