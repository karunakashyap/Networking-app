...
const HomeScreenHeader = () => {
  ...
  return (
    <div>
      <div className={styles.avatarData} onMouseOver={editProfile} onMouseOut={notShow}>
        ...
        <div className={styles.userData} >
          ...
          <div style={{padding:'5px',  width: '635px',border:userDataBorder}}>
          <h1> 
      ...
      <div style={{position:'relative',left:tagLeft,top:'165px',width:'700px'}} onMouseOver={editProfile} >
